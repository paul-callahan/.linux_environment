...
alias chrome-insecure="'/Applications/Google Chrome.app/Contents/MacOS/Google Chrome' --disable-web-security --user-data-dir=~/dev/chrome_data_dir --no-default-browser-check"
alias k="kubectl"
